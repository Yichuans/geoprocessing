...
biogeo_theme_names = {'Biogeographical province': 'udv_dcw_p',
               ...
               'Terrestrial biome/realm 2017': 'ecos_2017_rb', ## THIS NEEDS NEW ANALYSES
               'Terrestrial ecoregion 2017': 'ecos_2017_e',
...
def process_a_theme(sheet, start_row, site_id, theme_name, themekey):
    ...
    for base_unit_raw in base_units:
        ...
        # look up table here
        try:
            # exception for the new ecos_2017_clean data
            if theme_name == 'Terrestrial biome/realm 2017':
                base_name = base_unit

            # the old way of testing whether look up values are needed
            else:
