...
BASE_LOOKUP = {'eba': ['eba','ebaname', 'eba', 'ebaname', 'ebaname'],
      ...
      'ecos_2017_e': ['ecos_2017_clean', 'eco_name', 'ecos_2017_clean','eco_name','eco_name'],
      'ecos_2017_b': ['ecos_2017_clean', 'biome_name', 'ecos_2017_clean','biome_name','biome_name'],
      'ecos_2017_r': ['ecos_2017_clean', 'realm', 'ecos_2017_clean','realm','realm'],
      'ecos_2017_rb': ['ecos_2017_clean', 'realm_biome', 'ecos_2017_clean','realm_biome','realm_biome'],
...
def wh():
    ...
    wb.save(r'E:\Yichuan\Comparative_analysis_2017\wh_2017_full.xlsx')
